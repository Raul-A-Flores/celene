...
const Hero = () => (
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
   ...
   //  <iframe src="https://player.twitch.tv/?channel=hebecelene&parent=www.example.com" frameborder="0" allowfullscreen="true" scrolling="no" height="378" width="620"></iframe>
